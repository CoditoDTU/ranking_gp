"""
Pairwise comparison generation utilities.

Moved from src/datatools.py
"""
import torch
...
def get_comparisons(
    ...
    utility_matrix = sorted_y.unsqueeze(1) - sorted_y.unsqueeze(0)

    triu_mask = torch.triu(torch.ones_like(utility_matrix), diagonal=1).bool()
    valid_mask = triu_mask & (utility_matrix > epsilon)
